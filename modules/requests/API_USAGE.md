...
| `GET /requests/dispatch-plans` | Dispatch Plan list/detail shell | API_DEV_SMOKE_PASSED_PENDING_BROWSER_SMOKE |
...
| `GET /requests/dispatch-runs` | Dispatch Run list for selected unit/plan | API_DEV_SMOKE_PASSED_PENDING_BROWSER_SMOKE |
...
- Dispatch Plan and Run list API smoke passed on 2026-07-23 after applying the 007 DB package and repository SQL cast fix. Browser smoke remains pending.
