  ...
  return (
    <main className="h-screen overflow-hidden bg-background p-4 text-foreground">
      <section
        ...
        className="mx-auto grid h-full max-h-[736px] max-w-[1120px] grid-cols-[410px_minmax(0,1fr)] overflow-hidden rounded-md border border-border bg-card shadow-sm max-lg:grid-cols-1 max-lg:overflow-y-auto"
      >
        <div className="flex flex-col justify-between bg-sidebar p-7 text-sidebar-foreground">
          <div>
          ...
          <div className="rounded-md border border-white/20 bg-white/10 p-3 text-xs leading-5 text-blue-50">
        ...
        <div className="flex min-h-0 flex-col gap-4 p-7">
          ...
          <form onSubmit={handleSubmit} className="rounded-md border border-border bg-background p-4">
            ...
            <div className="mt-4 flex items-center justify-between gap-3">
              ...
              <Button type="submit" className="h-11 px-5" disabled={loginMutation.isPending}>
            ...
            <div className="mt-3 grid grid-cols-2 gap-3">
              {landingRoles.map((role) => (
                <button
                  ...
                  className={[
                    "rounded-md border p-3 text-left transition hover:border-primary hover:bg-accent",
