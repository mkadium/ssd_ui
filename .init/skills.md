...
Defines UI-specific AI skills.

## Skills

| Skill | When To Use | Expected Output |
|---|---|---|
| Page Flow Design | New or changed user workflow | Updated `PAGE_FLOWS.md` |
| Component Mapping | New or changed UI component | Updated `COMPONENT_MAP.md` |
| API Usage Review | UI consumes or changes API usage | Updated `API_USAGE.md` |
